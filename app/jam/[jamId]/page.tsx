  ...
  return (
    <div className="min-h-screen bg-gray-300 ">
      ...
      <div className="grid grid-cols-2 gap-2 w-[1300px] max-w-[75%] mx-auto py-12 ">
        <div className="bg-[rgb(170_170_170/0.7)] rounded-lg flex justify-center pt-8 pb-10 px-8">
        ...
        <div className="bg-[rgb(170_170_170/0.7)] rounded-lg flex pt-8 pb-10 px-8">
