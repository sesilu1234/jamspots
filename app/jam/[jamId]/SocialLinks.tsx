...
export default function SocialLinks({ socialLinks }: SocialLinksProps) {
  ...
  // no links → show nothing
  if (!instagram && !facebook && !siteWeb) return null;

  return (
    <div className="inline-flex gap-8 bg-[rgb(170_170_170/0.7)] p-6 rounded-lg w-1/2">
      {instagram ? (
        <div className="flex items-center gap-2">
          ...
          <a
            ...
            className=" underline-offset-2 hover:underline opacity-80 hover:opacity-100"
          >
            {instagram}
          </a>
        </div>
      ...
      {facebook ? (
        <div className="flex items-center gap-2">
          ...
          <a
            href={facebook.startsWith('http') ? siteWeb : `https://${facebook}`}
            target="_blank"
            rel="noopener noreferrer"
            className=" underline-offset-2 hover:underline opacity-80 hover:opacity-100"
          >
